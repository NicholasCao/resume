...
- 2022-10 至今 阿里云-PAI团队
  - Beautiful Prompt: 
    - 基于Stable Diffusion的prompt engineering，使用ChatGPT等工具自动生成数据集，并基于SFT和RLAIF微调bloom-1b1。优化后的图片质量大大优于原始prompt，效果可比肩甚至超越PromptPerfect。
    - 产出论文: [EMNLP 2023 industry 在投]
...
### 竞赛/项目经历
- 粤港澳大湾区国际算法算例大赛-预训练语言模型应用调优算法（总奖金100W）:
  <!-- - 第一名团队（获60W奖金，主要贡献）； -->
